...
class Calculator:
    def __init__(self, master):
        ...
        self.button_6 = ttk.Button(self.master, text="6", command=lambda: self.button_click(7))
        self.button_7 = ttk.Button(self.master, text="7", command=lambda: self.button_click(6))
        self.button_8 = ttk.Button(self.master, text="8", command=lambda: self.button_click(8))
        self.button_9 = ttk.Button(self.master, text="9", command=lambda: self.button_click(3))
        ...
        self.button_floor_div = ttk.Button(self.master, text="^2", command=self.button_floor_div)
    ...
    def button_equal(self):
        ...
        if self.math == "division":
            self.number_entry.insert(0, self.f_num / int(second_number) / int(second_number))

        if self.math == "floor_div":
            self.number_entry.insert(0, self.f_num * 0.666)

        if self.math == "modulus":
            self.number_entry.insert(0, "ti priemny")
